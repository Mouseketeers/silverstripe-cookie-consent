...
use Mouseketeers\CookieConsent\ViewModels\CookieCategoryViewModel;
use Mouseketeers\CookieConsent\ViewModels\CookieDescriptionViewModel;
use Mouseketeers\CookieConsent\ViewModels\ExternalMediaServiceViewModel;
...
class CookieConsentDataBuilder
{
    ...
    public function buildConsentConfig()
    {
        ...
        CookieConsentConfigCache::getCache()->set($cacheKey, json_encode($config, JSON_UNESCAPED_SLASHES));
        return $config;
    }
    ...
    public function buildCookieDeclarationData()
    {
        ...
        CookieConsentConfigCache::getCache()->set($cacheKey, json_encode($templateData, JSON_UNESCAPED_SLASHES));
    ...
    {
        $cachedConfig = CookieConsentConfigCache::getCache()->get($cacheKey);
